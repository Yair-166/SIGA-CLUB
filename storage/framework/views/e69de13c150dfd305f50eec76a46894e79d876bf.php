...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" id="username" name="email" placeholder="Ingresa el correo">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <span class="invalid-feedback" role="alert">
                                                <strong>Correo o contraseña invalidos.</strong>
                                            </span>
                                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="forgot-password" class="text-muted">Olvide mi contraseña</a>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Ingresa la contraseña" id="password-input" value="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">¿No tienes cuenta? <a href="register" class="fw-semibold text-primary text-decoration-underline"> Registrarse </a> </p>
                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SIGA-CLUB\resources\views/auth/login.blade.php ENDPATH**/ ?>