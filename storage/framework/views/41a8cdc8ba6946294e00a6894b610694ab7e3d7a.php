...
<?php $__env->startSection('content'); ?>
    ...
    <input type="hidden" id="asistencias_previstas" value="<?php echo e($asistencias_previstasj); ?>"/>
    <input type="hidden" id="rol_usr" value="<?php echo e(Auth::user()->rol); ?>"/>
    <div class="row">
        <div class="col-12">
            <div class="row">
                <div class="col-xl-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SIGA-CLUB\resources\views/apps-calendario-participante.blade.php ENDPATH**/ ?>