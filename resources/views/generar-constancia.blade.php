...
<body>
    ...
    <div class="contenido">
        ...
        <div id="cuerpo" style='height:400px; width: 100%;'>
            ...
            <p align="left">
                <span class="ft11">
                    Con el número de boleta ______________, participo en el "{{$club->nombre}}” en la actividad {{$evento->nombre}} 
            ...
            <p align="left">
                <span class="ft11">
                    No existiendo inconveniente alguno, se emite la presente a los {{$dia}} días del mes de {{$mes}} del 
                    {{$anio}} a solicitud expresa y para los fines que el (la) interesado (a) convengan.
                </span>
            </p>
        </div>
