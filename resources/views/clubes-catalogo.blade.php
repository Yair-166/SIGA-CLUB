...
@section('content')
    ...
    @endphp
    <div class="row">
    @if ( (Auth::user()->rol == 'administrador' && Auth::user()->clubes > 0) || Auth::user()->rol == 'super')
       <div class="col-lg-12">
            <div class="card">
                                                ...
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    ...
                                                    @if ($club->idAdministrador == Auth::user()->id || Auth::user()->rol == 'super')
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                            ...
                                                            <a class="edit-item-btn" href="{{URL::asset('/dashboard?club='.$club->id)}}">
                                ...
                                <form action="{{ route('updateClub') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select class="form-select" name="idAdministrador" required>
                                                            ...
                                                            @foreach ($administradores as $administrador)
                                                                <option value="{{ $administrador->id }}">{{ $administrador->name }} {{ $administrador->apaterno }} {{ $administrador->amaterno }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                @endif
                                            ...
                                            <div class="col-lg-6">
                                                <div>
                                                    <label for="location-field" class="form-label">Por favor ingrese la ubicación de la escuela y el salón, por ejemplo: Escuela XYZ, Salón ABC</label>
