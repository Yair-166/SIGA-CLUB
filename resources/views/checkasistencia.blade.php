                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center pt-4">
                                <div class="">
                                    @if($ipn)
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/7/72/Logo_IPN.png" alt="" width="42%">
                                        <img src="{{ URL::asset('images/' . $club->foto) }}" alt="" class="move-animation" width="42%"" style="inline-block">
                                    @else
                                        <img src="{{ URL::asset('images/' . $club->foto) }}" alt="" class="error-basic-img move-animation">
                                    @endif
                                </div>
                                <div class="mt-n4">
