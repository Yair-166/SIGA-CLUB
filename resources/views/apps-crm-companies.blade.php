                                            ...
                                            <div class="col-lg-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        disabled/>
                                                    <input type="hidden" id="owner-field" class="form-control" value="{{ Auth::user()->id }}" disabled/>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div>
            ...
            <div class="card" id="company-view-detail">
                <div class="card-body text-center">
                    <div class="position-relative d-inline-block">
                        <div class="avatar-md">
                            <div class="avatar-title bg-light rounded-circle">
                                <img src="{{ URL::asset('assets/images/users/multi-user.jpg') }}" alt="" class="avatar-sm rounded-circle object-cover">
                            </div>
                        </div>
                    </div>
